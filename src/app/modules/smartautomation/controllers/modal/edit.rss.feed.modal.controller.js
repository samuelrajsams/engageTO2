(function (angular) {
    ...
    angular
            ...
            .controller('EditRssFeedController', editRssFeedController);

    editRssFeedController.$inject = [
        '$scope',
        '$rootScope',
        '$uibModalInstance',
    ...
    function editRssFeedController(
            $scope,
            $rootScope,
            $uibModalInstance,
            SmartAutomationService,
        ...
        function saveRssFeed() {
            ...
            if ($scope.addRssFeed.rssFeed.name === '') {
                ...
                var rssFeedDetails = {
                    ...
                    image: $scope.addRssFeed.rssFeed.logo
                };
                console.log(rssFeedDetails);
//            SmartAutomationService.updateRssFeed(rssFeedDetails).then(function (addRssFeedResponse) {
